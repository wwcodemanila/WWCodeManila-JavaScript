...
## Acknowledgments
We would like to thank Heroku and AlterConf for their excellent codes of conducts, which we used as a guide for ouw own. We also extend thanks and gratitude to the Women Who Code members, directors, advisors, and allies who helped create this code of conduct and continue to help us improve as an organization everyday.
